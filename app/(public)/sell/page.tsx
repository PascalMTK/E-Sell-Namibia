  ...
  return (
    <Container className="max-w-3xl py-12">
      <div className="mb-8 text-center">
        <p className="mb-2 text-xs font-bold uppercase tracking-widest text-amber-700">Sell through ESell</p>
        ...
        <p className="mx-auto mt-3 max-w-xl text-sm text-secondary-text">
          Have something you no longer need? Send us the details and our ESell team will review your item and
          contact you.
        </p>
      </div>
